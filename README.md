...
Live structure: a hero intro, a `#work` section listing six projects as "inspector panel"-styled cards (status pill, description, spec table, links), and a `#contact` section.
...
- **Quick-Draw Duel** — Prototype. Wild West-style reflex duel game. Unity Timeline-driven cinematic intro leads into reaction-time duel gameplay. Playable on itch.io, source on GitHub.
